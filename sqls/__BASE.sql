...
(
   tc_id                numeric(40,0) not null comment '训练ID',
   enum_id              numeric(10,0) comment '枚举ID',
   stu_id               varchar(30) comment '学生学号',
   tc_url               varchar(60) not null comment '训练URL',
...
(
   comm_id              numeric(40,0) not null comment '交流ID',
   teaching_id          numeric(10,0) comment '教学资源ID',
   stu_id               varchar(30) comment '学生学号',
   tea_id               varchar(30) comment '老师工号',
   question             varchar(60) not null comment '交流内容',
   target_reply         varchar(60) not null comment '回复ID',
...
(
   q_id                 numeric(10,0) not null comment '题目编号',
   q_content            varchar(60) not null comment '题目内容',
   primary key (q_id)
);
...
(
   o_id                 numeric(10,0) not null comment '答案ID',
   q_id                 numeric(10,0) comment '题目编号',
   o_content            varchar(60) not null comment '答案内容',
   result               numeric(1,0) not null comment '是否为答案',
   primary key (o_id)
);
...
(
   teas_id              numeric(40,0) not null comment '资源ID',
   teaching_id          numeric(10,0) comment '教学资源ID',
   teas_url             varchar(255) not null comment '资源URL',
   primary key (teas_id)
);
...
(
   view_id              numeric(10,0) not null comment '记录ID',
   stu_id               varchar(30) comment '学生学号',
   teaching_id          numeric(10,0) comment '教学资源ID',
   viewed_at            date not null comment '观看时间',
   view_duration        numeric(40,0) not null comment '观看时长',
   primary key (view_id)
);
...
(
   phys_id              numeric(40,0) not null comment '成绩ID',
   stu_id               varchar(30) comment '学生学号',
   phy_id               numeric(40,0) comment '任务ID',
   phys_stamina2        numeric(40,3) not null comment '耐力',
   phys_speed2          numeric(40,3) not null comment '速度',
   primary key (phys_id)
);
...
(
   phy_id               numeric(40,0) not null comment '任务ID',
   tea_id               varchar(30) comment '老师工号',
   enum_id              numeric(10,0) comment '枚举ID',
   phy_name             varchar(40) not null comment '任务名称',
   phy_descript         varchar(40) not null comment '任务描述',
...
(
   a_id                 numeric(40,0) not null comment '考勤ID',
   stu_id               varchar(30) comment '学生学号',
   cr_id                numeric(40,0) comment '课堂ID',
   a_type               varchar(60) not null comment '考勤类型',
   evaluation_type2     varchar(60) not null comment '评价类型',
   primary key (a_id)
);
...
(
   ip_id                numeric(40,0) not null comment '思政表现ID',
   stu_id               varchar(30) comment '学生学号',
   cr_id                numeric(40,0) comment '课堂ID',
   ip_type              varchar(60) not null comment '思政表现类型',
   primary key (ip_id)
);
...
(
   se_id                numeric(40,0) not null comment '学生互评ID',
   cr_id                numeric(40,0) comment '课堂ID',
   stu_id               varchar(30) comment '学生学号',
   es_id                varchar(40) not null comment '被评学生学号',
   e_type               varchar(40) not null comment '评价类型',
   pe_id                varchar(40) not null comment '参评学生学号',
   primary key (se_id)
);
...
(
   ta_id                numeric(40,0) not null comment '助教评价ID',
   stu_id               varchar(30) comment '学生学号',
   cr_id                numeric(40,0) comment '课堂ID',
   ta_type              varchar(60) not null comment '评价类型',
   ta_stu               numeric(30,0) not null comment '评价者',
   primary key (ta_id)
);
...
(
   tae_id               numeric(40,0) not null comment '教师评价ID',
   tea_id               varchar(30) comment '老师工号',
   g_id                 numeric(10,0) comment '小组ID',
   cr_id                numeric(40,0) comment '课堂ID',
   tae_type             varchar(60) not null comment '评价类型',
   primary key (tae_id)
);
...
(
   crs_id               numeric(40,0) not null comment '课堂评价ID',
   ts_id                numeric(40,0) comment '总分ID',
   crs_score            numeric(40,3) not null comment '成绩',
   primary key (crs_id)
);
...
(
   dri_id               varchar(40) not null comment '运球ID',
   ms_id                numeric(40,0) comment '评分ID',
   dri_stability        numeric(40,3) not null comment '稳定性',
   dri_power            numeric(40,3) not null comment '力量',
   dri_speed            numeric(40,3) not null comment '速度',
   dri_analysis         varchar(255) not null comment '分析',
   primary key (dri_id)
);

alter table a_dribble comment 'A 运球表
...
(
   er_id                numeric(40,0) not null comment '资源ID',
   ms_id                numeric(40,0) comment '评分ID',
   er_picture           varchar(60) not null comment '练习URL',
...
(
   et_id                numeric(40,0) not null comment '任务ID',
   tea_id               varchar(30) comment '老师工号',
   ms_id                numeric(40,0) comment '评分ID',
   enum_id              numeric(10,0) comment '枚举ID',
   et_name              varchar(60) not null comment '任务名称',
   et_description       varchar(60) not null comment '任务描述',
...
(
   ms_id                numeric(40,0) not null comment '评分ID',
   stu_id               varchar(30) comment '学生学号',
   tea_id               varchar(30) comment '老师工号',
   ms_score             numeric(10,3) not null comment 'EROCK评分',
   ms_time              date not null comment '评分时间',
   ms_dribble           numeric(40,3) not null comment '运球分数',
   ms_shooting          numeric(40,3) not null comment '投篮分数',
   primary key (ms_id)
);
...
(
   mas_id               numeric(40,0) not null comment '资源ID',
   tc_id                numeric(40,0) comment '训练ID',
   teas_url             varchar(255) not null comment '资源URL',
   primary key (mas_id)
);

alter table b1_mass_source comment 'B1 社团资源表
...
(
   trs_id               numeric(40,0) not null comment '训练评价ID',
   ts_id                numeric(40,0) comment '总分ID',
   trs_score            numeric(40,3) not null comment '成绩',
   primary key (trs_id)
);
...
(
   bp_id                numeric(40,0) not null comment '加分ID',
   stu_id               varchar(30) comment '学生学号',
   cr_id                numeric(40,0) comment '课堂ID',
   bp_value             numeric(10,0) not null comment '分值',
   bp_name              varchar(20) not null comment '加分名称(备注',
   primary key (bp_id)
);
...
(
   tp_id                numeric(40,0) not null comment '成绩ID',
   stu_id               varchar(30) comment '学生学号',
   tp_value             numeric(10,3) not null comment '总成绩',
   primary key (tp_id)
);
...
(
   c_r_id               numeric(40,0) not null comment '记录ID',
   c_r_score            varchar(40) not null comment '记录比分',
   session_time         date not null comment '场次时间',
   specification        varchar(10) not null comment '比赛规格',
   c_r_name             varchar(60) not null comment '比赛名称',
   primary key (c_r_id)
);
...
(
   ps_id                numeric(40,0) not null comment '人员ID',
   c_r_id               numeric(40,0) comment '记录ID',
   stu_id               varchar(30) comment '学生学号',
   ps_name              varchar(60) not null comment '职位',
   primary key (ps_id)
);
...
(
   proof_id             numeric(40,0) not null comment '佐证ID',
   ps_id                numeric(40,0) comment '人员ID',
   proof_url            varchar(60) not null comment '佐证URL',
...
(
   evs_id               numeric(40,0) not null comment '赛事评价ID',
   ts_id                numeric(40,0) comment '总分ID',
   evs_score            numeric(40,3) not null comment '成绩',
   primary key (evs_id)
);
...
(
   cr_id                numeric(40,0) not null comment '课堂ID',
   semester_id          numeric(60,0) comment '学期ID',
   cr_date              date not null comment '开课时间',
   cr_main              varchar(60) not null comment '课题内容',
   cr_duration          numeric(30,3) not null comment '开课时长',
   primary key (cr_id)
);
...
(
   con_t_score          numeric(40,3) not null comment 'T分',
   con_pro_score        numeric(40,3) not null comment '进步分',
   primary key (con_t_score)
);

alter table conversion comment '进步分换算表
...
(
   certificate_id       numeric(40,0) not null comment '证书ID',
   stu_id               varchar(30) comment '学生学号',
   tea_id               varchar(30) comment '老师工号',
   certificate_name     varchar(60) not null comment '证书名称',
   audit                numeric(1,0) not null comment '证书审核',
...
(
   resource_id          numeric(40,0) not null comment '资源ID',
   certificate_id       numeric(40,0) comment '证书ID',
   resource_url         varchar(60) not null comment '资源url',
...
(
   avs_id               numeric(40,0) not null comment '增值评价ID',
   ts_id                numeric(40,0) comment '总分ID',
   avs_score            numeric(40,3) not null comment '成绩',
   primary key (avs_id)
);
...
(
   enum_id              numeric(10,0) not null comment '枚举ID',
   enum_name            varchar(20) not null comment '枚举名称',
   enum_code            varchar(10) not null comment '枚举代码',
   primary key (enum_id)
);
...
create table grade
(
   class_id             numeric(10,0) not null comment '班级编号',
   class_name           varchar(40) not null comment '专业班级名',
...
(
   semester_id          numeric(60,0) not null comment '学期ID',
...
create table shoot
(
   sho_id               varchar(40) not null comment '投篮ID',
   ms_id                numeric(40,0) comment '评分ID',
   sho_arc              numeric(40,3) not null comment '弧线',
   sho_spinner          numeric(40,3) not null comment '后旋',
   sho_angle            numeric(40,3) not null comment '偏角',
   sho_analysis         varchar(255) not null comment '评价',
   primary key (sho_id)
);

alter table shoot comment '投篮表
...
(
   g_id                 numeric(10,0) not null comment '小组ID',
   g_name               varchar(60) not null comment '小组名',
   stu_group_leader     numeric(40,0) not null comment '小组组长',
   primary key (g_id)
);
...
(
   stu_id               varchar(30) not null comment '学生学号',
   tea_id               varchar(30) not null comment '老师工号',
...
(
   stu_id               varchar(30) not null comment '学生学号',
   g_id                 numeric(10,0) comment '小组ID',
   class_id             numeric(10,0) comment '班级编号',
   stu_name             varchar(60) not null comment '学生姓名',
   stu_password         varchar(60) not null comment '学生密码',
   primary key (stu_id)
);
...
(
   tea_id               varchar(30) not null comment '老师工号',
   tea_name             varchar(60) not null comment '老师姓名',
...
(
   teaching_id          numeric(10,0) not null comment '教学资源ID',
   tea_id               varchar(30) comment '老师工号',
   view_id              numeric(10,0) comment '记录ID',
   resource_url         varchar(60) not null comment '资源url',
...
(
   ts_id                numeric(40,0) not null comment '总分ID',
   semester_id          numeric(60,0) comment '学期ID',
   ep_score             numeric(40,3) not null comment '期末成绩',
   primary key (ts_id)
);
...
alter table a1_communication add constraint "FK_A1 tea to comm" foreign key (tea_id)
...
alter table a1_communication add constraint "FK_A1_stu_ to_comm" foreign key (stu_id)
      references student (stu_id) on delete restrict on update restrict;

alter table a1_result add constraint "FK_A1 q to o" foreign key (q_id)
      references a1_question (q_id) on delete restrict on update restrict;
...
alter table a2_teaching_assistant_evaluation add constraint "FK_A2 g to te" foreign key (g_id)
      references stu_group (g_id) on delete restrict on update restrict;
...
alter table a_dribble add constraint "FK_mark_sheet to dri" foreign key (ms_id)
...
alter table a_exercise_task add constraint "FK_et to score" foreign key (ms_id)
      references a_mark_sheet (ms_id) on delete restrict on update restrict;
...
alter table c2_personnel_sheet add constraint "FK_C2 cr to ps" foreign key (c_r_id)
      references c2_competition_record (c_r_id) on delete restrict on update restrict;
...
alter table shoot add constraint "FK_mark_sheet to sho" foreign key (ms_id)
      references a_mark_sheet (ms_id) on delete restrict on update restrict;
...
alter table student add constraint "FK_group to stu" foreign key (g_id)
      references stu_group (g_id) on delete restrict on update restrict;
